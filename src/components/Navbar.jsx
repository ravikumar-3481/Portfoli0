        ...
        <nav className="navbar" id="nav">
          ...
          <div className="links">
            <ul className="nav-links">
              ...
              <li><span onClick={() => handleLinkClick('#experience')} style={{ cursor: 'pointer' }}>Experience</span></li>
              <li><span onClick={() => handleLinkClick('#education')} style={{ cursor: 'pointer' }}>Education</span></li>
            ...
            {menuActive && (
              <>
                ...
                >
                  ...
                  <span onClick={() => handleLinkClick('#experience')} style={{ cursor: 'pointer' }}>Experience</span>
